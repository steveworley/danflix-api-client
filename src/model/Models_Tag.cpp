...
void Models_Tag::validate()
{
    // TODO: implement validation
}

web::json::value Models_Tag::toJson() const
{
...
bool Models_Tag::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Models_Tag::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Models_Tag::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Models_Tag::getCreatedAt() const
{
    return m_CreatedAt;
}


void Models_Tag::setCreatedAt(const utility::string_t& value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool Models_Tag::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void Models_Tag::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
std::shared_ptr<Gorm_DeletedAt> Models_Tag::getDeletedAt() const
{
    return m_DeletedAt;
}


void Models_Tag::setDeletedAt(const std::shared_ptr<Gorm_DeletedAt>& value)
{
    m_DeletedAt = value;
    m_DeletedAtIsSet = true;
}

bool Models_Tag::deletedAtIsSet() const
{
    return m_DeletedAtIsSet;
}

void Models_Tag::unsetDeletedAt()
{
    m_DeletedAtIsSet = false;
}
int32_t Models_Tag::getId() const
{
    return m_Id;
}

void Models_Tag::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Models_Tag::idIsSet() const
{
    return m_IdIsSet;
}

void Models_Tag::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t Models_Tag::getName() const
{
    return m_Name;
}


void Models_Tag::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Models_Tag::nameIsSet() const
{
    return m_NameIsSet;
}

void Models_Tag::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Models_Tag::getUpdatedAt() const
{
    return m_UpdatedAt;
}


void Models_Tag::setUpdatedAt(const utility::string_t& value)
{
    m_UpdatedAt = value;
    m_UpdatedAtIsSet = true;
}

bool Models_Tag::updatedAtIsSet() const
{
    return m_UpdatedAtIsSet;
}

void Models_Tag::unsetUpdatedAt()
{
    m_UpdatedAtIsSet = false;
}
