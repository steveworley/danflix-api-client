...
Models_GameSave::Models_GameSave()
{
    ...
    m_Id = 0;
    m_IdIsSet = false;
    m_PatchId = utility::conversions::to_string_t("");
...
bool Models_GameSave::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("patchId"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_setPatchId;
...
utility::string_t Models_GameSave::getPatchId() const
{
    return m_PatchId;
}


void Models_GameSave::setPatchId(const utility::string_t& value)
{
    m_PatchId = value;
    m_PatchIdIsSet = true;
}
