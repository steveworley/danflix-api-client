...
Routes_CreateProfileRequest::Routes_CreateProfileRequest()
{
...
void Routes_CreateProfileRequest::validate()
{
    // TODO: implement validation
}

web::json::value Routes_CreateProfileRequest::toJson() const
{
...
bool Routes_CreateProfileRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Routes_CreateProfileRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Routes_CreateProfileRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Routes_CreateProfileRequest::getAvatar() const
{
    return m_Avatar;
}


void Routes_CreateProfileRequest::setAvatar(const utility::string_t& value)
{
    m_Avatar = value;
    m_AvatarIsSet = true;
}

bool Routes_CreateProfileRequest::avatarIsSet() const
{
    return m_AvatarIsSet;
}

void Routes_CreateProfileRequest::unsetAvatar()
{
    m_AvatarIsSet = false;
}
utility::string_t Routes_CreateProfileRequest::getName() const
{
    return m_Name;
}


void Routes_CreateProfileRequest::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Routes_CreateProfileRequest::nameIsSet() const
{
    return m_NameIsSet;
}

void Routes_CreateProfileRequest::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Routes_CreateProfileRequest::getPin() const
{
    return m_Pin;
}


void Routes_CreateProfileRequest::setPin(const utility::string_t& value)
{
    m_Pin = value;
    m_PinIsSet = true;
}

bool Routes_CreateProfileRequest::pinIsSet() const
{
    return m_PinIsSet;
}

void Routes_CreateProfileRequest::unsetPin()
{
    m_PinIsSet = false;
}
utility::string_t Routes_CreateProfileRequest::getType() const
{
    return m_Type;
}


void Routes_CreateProfileRequest::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool Routes_CreateProfileRequest::typeIsSet() const
{
    return m_TypeIsSet;
}

void Routes_CreateProfileRequest::unsetType()
{
    m_TypeIsSet = false;
}
