...
void Models_Language::validate()
{
    // TODO: implement validation
}

web::json::value Models_Language::toJson() const
{
...
bool Models_Language::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Models_Language::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Models_Language::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t Models_Language::getId() const
{
    return m_Id;
}

void Models_Language::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Models_Language::idIsSet() const
{
    return m_IdIsSet;
}

void Models_Language::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t Models_Language::getName() const
{
    return m_Name;
}


void Models_Language::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Models_Language::nameIsSet() const
{
    return m_NameIsSet;
}

void Models_Language::unsetName()
{
    m_NameIsSet = false;
}
